...
interface CardHistViagensProps {
    viagem: Viagem;
}

function CardHistViagens({ viagem }: CardHistViagensProps) {
    ...
    return (
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-lg mx-auto my-4 p-4 border border-gray-300 transition-transform hover:scale-105">
            ...
            <div className="py-4 px-2 text-gray-700 space-y-2">
                ...
                {isExpanded && (
                    <><p><strong>Data:</strong>{" "} {new Intl.DateTimeFormat("pt-BR", { dateStyle: "full", }).format(new Date(viagem.data + "T12:00:00"))}
                        . Às {viagem.hora}</p>
...
export default CardHistViagens