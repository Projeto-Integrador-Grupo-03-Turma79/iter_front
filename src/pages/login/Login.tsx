        ...
        <>
            ...
            <Components.Container>
                <div className="grid grid-cols-2 h-screen place-items-center font-bold">
                    <form className=" mt-10 flex justify-start items-center flex-col w-1/4 gap-4"
                        onSubmit={login}>
                        <div className='grid grid-cols '><h2 className="text-slate-900 text-[4vw] mb-7">Entrar</h2></div>
                        <div className="relative z-0 mb-5 group flex flex-col w-[20vw] text-[18px]">
                            <input className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-black dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:border-yellow-600 peer"
                                type="text"
                                name="usuario"
                                id="usuario"
                                placeholder=" "
                        ...
                        <div className="relative z-0 mb-5 flex flex-col w-[20vw]">
                        ...
                        <button
                            type='submit'
                            className="bg-[#f1af09] hover:bg-slate-900 flex justify-center rounded-3xl w-[15vw] text-white py-2">
                    ...
                    <div className=" min-w-[90vw] hidden lg:block">
                        < Cadastro />
                    </div>
