        ...
        <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative  rounded-lg shadow-sm bg-[#003152]">
                ...
                <div className="p-4 md:p-5 text-center">
                    ...
                    <h3 className="mb-4 text-xl font-normal text-white">Tem certeza que quer deletar esse motorista?</h3>
                    <h2 className="text-[16px] font-normal text-white">Nome: {veiculo.motorista} </h2>
                    <h2 className="mb-6 text-[16px] font-normal text-white">Carro: {veiculo.marca} {veiculo.modelo} {veiculo.cor}  </h2>
                    <button onClick={deletarVeiculo} className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        {isLoading ?
                            <RotatingLines
                                strokeColor="white"
                                strokeWidth="5"
